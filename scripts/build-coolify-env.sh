...
ADDITIONAL_REDIRECT_URLS=https://domovina.ai/**,https://www.domovina.ai/**,https://domovina.energy/**,https://www.domovina.energy/**,https://domovina.tv/**,https://www.domovina.tv/**,http://localhost:3000/**,http://localhost:5173/**,https://pinka-app.pages.dev/**,https://pinka.finance/**,https://www.pinka.finance/**,https://app.pinka.finance/**,https://pinka.io/**,https://www.pinka.io/**,https://fiskal-app.domovina.ai/**,https://domovina-fiskal-app.pages.dev/**
JWT_EXPIRY=3600
